  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      if (!sessionResponse.ok || !session?.csrfToken) {
        throw new Error(
          "Unable to connect to registration. Please try again."
        )
      }
        ...
        <fieldset disabled={busy} className="auth-fields">
          {ownerMode && (
            <div>
              ...
              <p className="auth-small">
                An existing owner generates this in Accounts.
                This is not a public owner sign-up.
              </p>
            </div>
          )}
          ...
          <div>
            ...
            <input
              ...
              placeholder={
                ownerMode
                  ? "Email used for your invitation"
                  : "you@example.com"
              }
              value={form.email}
              onChange={handleChange}
